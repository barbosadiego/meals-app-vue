<template>
  <section class="mealsSearch">
    <Loading v-if="isLoading" />
    <div v-else class="container mealsSearch__grid">
      <div class="mealsSearch__item" v-for="item in mealData" :key="item.idMeal">
        <img
          :src="item.strMealThumb"
          :alt="item.strMeal"
          @click="$emit('mealItem', item.idMeal)"
        />
        <div class="mealsSearch__description">
          <p>{{ item.strMeal }}</p>
